...
**MUST use bullet points describing what was done.** Structure as:

1. **Summary** - One sentence overview of the PR purpose
2. **Changes** - Bullet points describing what was added/modified/removed (no file paths)
3. **Impact** - How this affects users or the system

**Good example:**

```markdown
**Summary**: Adds a new DataTable component with sorting and pagination.

**Changes:**

- Added DataTable component with sortable columns and ascending/descending toggle
- Added pagination sub-component with page size selector (10, 25, 50, 100) and navigation controls
- Added TypeScript interfaces for DataTableProps, Column, SortConfig, and PaginationProps
- Added custom hook to manage sort state and provide sorted data
- Added Storybook stories demonstrating basic, sortable, and paginated variants

**Impact:**

- Users can now sort large datasets by clicking column headers
- Pagination reduces initial load time for tables with 100+ rows
```
