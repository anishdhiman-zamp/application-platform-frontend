...
export const FONT_PRESET_COOKIE = 'zamp_font_preset';
export const NAV_SIDEBAR_EXPANDED_COOKIE = 'zamp_nav_sidebar_expanded';
...
export const FONT_PRESET_COOKIE_MAX_AGE = 60 * 60 * 24 * 365; // 1 year
