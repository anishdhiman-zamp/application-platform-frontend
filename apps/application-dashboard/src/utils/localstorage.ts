...
export enum LOCAL_STORAGE_KEYS {
  ...
  PACE_OPEN_DYNAMIC_TABS = 'PACE_OPEN_DYNAMIC_TABS_V2',
  ...
  PACE_FILES_PANEL_WIDTH_FILES_SURFACE = 'PACE_FILES_PANEL_WIDTH_FILES_SURFACE',
  PACE_PAGE_SIDE_PANEL_WIDTH = 'PACE_PAGE_SIDE_PANEL_WIDTH',
  PACE_PAGE_SIDE_PANEL_WIDTHS = 'PACE_PAGE_SIDE_PANEL_WIDTHS',
  PACE_FILE_TREE_COLUMN_WIDTH = 'PACE_FILE_TREE_COLUMN_WIDTH',
  THEME = 'ZAMP_THEME',
  FONT_PRESET = 'ZAMP_FONT_PRESET',
  DATASET_ACTIVE_TAB = 'dataset_active_tab',
  ZAMP_DATASETS = 'ZAMP_DATASETS',
  PEV_LOCKED_CONVERSATIONS = 'PEV_LOCKED_CONVERSATIONS',
  PACE_SELECTED_MODEL = 'PACE_SELECTED_MODEL_V2',
  PACE_SIDEBAR_STATE = 'PACE_SIDEBAR_STATE',
  PACE_FILES_PANEL_EXPANDED = 'PACE_FILES_PANEL_EXPANDED',
  PACE_TREE_SIDEBAR_OPEN = 'PACE_TREE_SIDEBAR_OPEN',
  PACE_WORD_WRAP_ENABLED = 'PACE_WORD_WRAP_ENABLED',
