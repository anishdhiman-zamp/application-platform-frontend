...
import { ApprovalStatus, type ApproverDetailsType } from '@/deprecated/apis/policies.types';
import { APPROVAL_TYPE } from '@/deprecated/modules/payments/payments.constant';
