import { PolicyResultStatus, PolicyStepType } from '@/deprecated/apis/policies.types';
import ApprovalDetailsBadge from '@/deprecated/modules/payments/payment-details/components/ApprovalDetailsBadge';
