...
import type { TemplateDetailsType } from '@/deprecated/apis/paymentApi.types';
import { useGetTemplateListQuery } from '@/deprecated/apis/payments';
import TemplateFilter from '@/deprecated/modules/payments/move-money/components/TemplateFilter';
import { MOVE_MONEY_TEMPLATE_FILTER_ITEMS } from '@/deprecated/modules/payments/payments.constant';
import { type MOVE_MONEY_TYPE, TEMPLATE_STATUS_TYPES } from '@/deprecated/modules/payments/payments.types';
import RecipientCardSkeleton from '@/deprecated/modules/payments/recipients/components/RecipientCardSkeleton';
import CreateTemplatePopover from '@/deprecated/modules/payments/templates/components/CreateTemplatePopover';
import TemplateCard from '@/deprecated/modules/payments/templates/components/TemplateCard';
import { TEMPLATE_LIST_TABS } from '@/deprecated/modules/payments/templates/templates.constant';
