...
import { useGetPaymentConfigQuery, useLazyGetPoliciesQuery } from '@/deprecated/apis/payments';
import CreatePolicyDialog from '@/deprecated/modules/policies/create';
import PoliciesListSideDrawer from '@/deprecated/modules/policies/listing/PoliciesListSideDrawer';
import PolicyDeleteConfirmPopup from '@/deprecated/modules/policies/listing/PolicyDeleteConfirmPopup';
import { PolicyActionType, PolicyDialogType } from '@/deprecated/modules/policies/types';
