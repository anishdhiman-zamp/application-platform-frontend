...
import { RECIPIENT_CARD_ACTION_ITEMS } from '@/deprecated/modules/payments/payments.constant';
import { MOVE_MONEY_ACTION_TYPE, MOVE_MONEY_TYPE } from '@/deprecated/modules/payments/payments.types';
