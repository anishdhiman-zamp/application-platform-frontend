...
import { RecipientDetailsType, TemplateDetailsType } from '@/deprecated/apis/paymentApi.types';
import DropdownToggle from '@/deprecated/modules/payments/move-money/components/DropdownToggle';
import MoveMoneyTemplateListCard from '@/deprecated/modules/payments/move-money/components/MoveMoneyTemplateListCard';
import RecipientCard from '@/deprecated/modules/payments/move-money/components/RecipientCard';
import { MOVE_MONEY_PAYMENT_TYPE_OPTIONS } from '@/deprecated/modules/payments/payments.constant';
import { MOVE_MONEY_PAYMENT_TYPE } from '@/deprecated/modules/payments/payments.types';
