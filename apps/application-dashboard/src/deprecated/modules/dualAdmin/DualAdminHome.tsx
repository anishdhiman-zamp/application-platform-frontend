...
import { ResourceType } from '@/deprecated/apis/policies.types';
import RequestApprovalDialogue, {
  type RequestApprovalPolicyConfig,
} from '@/deprecated/modules/dualAdmin/components.tsx/RequestApprovalDialogue';
import DualAdminCard from '@/deprecated/modules/dualAdmin/DualAdminCard';
import { PolicyActionType } from '@/deprecated/modules/policies/types';
