...
import type { PolicyDetailsType } from '@/deprecated/apis/paymentApi.types';
import { TEMPLATE_APPROVAL_ACTION_TYPES } from '@/deprecated/modules/payments/payments.types';
import UpdatePolicyCard from '@/deprecated/modules/policies/components/UpdatePolicyCard';
import { APPROVAL_FAILED_TOAST, APPROVAL_POLICY_TOAST } from '@/deprecated/modules/policies/constants';
