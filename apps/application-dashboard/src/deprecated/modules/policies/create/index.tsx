...
import { CreatePolicyPayloadType } from '@/deprecated/apis/paymentApi.types';
import { useCreatePolicyMutation, useGetPaymentConfigQuery, useUpdatePolicyMutation } from '@/deprecated/apis/payments';
import { defaultConditions, getAttributes, transformFormDataToApiPayload } from '@/deprecated/modules/policies/commons';
import { DEFAULT_APPROVAL_STEP } from '@/deprecated/modules/policies/constants';
import ApprovalFlow from '@/deprecated/modules/policies/create/ApprovalFlow';
import AttributeInputDropdown from '@/deprecated/modules/policies/create/AttributeInputDropdown';
import AttributeMenuDropdown from '@/deprecated/modules/policies/create/AttributeMenuDropdown';
...
import {
  ...
  PolicyDialogType,
  PolicyFormData,
} from '@/deprecated/modules/policies/types';
