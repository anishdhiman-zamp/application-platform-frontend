...
import { AccountDetailsType } from '@/deprecated/modules/payments/payments.types';
import { attributesMap, payoutAttributes, templateAttributes } from '@/deprecated/modules/policies/create/constants';
import {
