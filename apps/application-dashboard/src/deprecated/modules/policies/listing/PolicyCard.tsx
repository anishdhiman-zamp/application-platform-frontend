...
import { PolicyDetailsType, PolicyMutateActionType } from '@/deprecated/apis/paymentApi.types';
import { PolicyResultStatus } from '@/deprecated/apis/policies.types';
import PolicyApproveCard from '@/deprecated/modules/dualAdmin/components.tsx/PolicyApproveCard';
import ReviewPolicyUpdatePopover from '@/deprecated/modules/policies/components/ReviewPolicyUpdatePopover';
import PolicyActionsDropdown from '@/deprecated/modules/policies/listing/PolicyActionsDropdown';
import PolicyAttributeTags from '@/deprecated/modules/policies/listing/PolicyAttributeTags';
