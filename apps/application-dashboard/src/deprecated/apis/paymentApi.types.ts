import type { PolicyConfigType, PolicyResultStatus } from '@/deprecated/apis/policies.types';
import {
  AccountDetailsType,
  MOVE_MONEY_TYPE,
  PAYMENT_STATUS_TYPES,
} from '@/deprecated/modules/payments/payments.types';
import { CreatePolicyConfigPayload, PolicyActionType } from '@/deprecated/modules/policies/types';
