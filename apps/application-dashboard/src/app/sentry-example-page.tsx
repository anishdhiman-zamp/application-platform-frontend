    ...
    <div>
      ...
      <main>
        ...
        <p className='description'>
          ...
          <a
            target='_blank'
            href='https://varni-labs-pte-ltd.sentry.io/issues/?project=4508794285129728'
            rel='noreferrer'
          >
            Issues Page
          </a>
              ...
              async () => {
                ...
                if (!res.ok) {
                  ...
                  Sentry.captureException(
                    new SentryExampleFrontendError('This error is raised on the frontend of the example page.'),
                  );
