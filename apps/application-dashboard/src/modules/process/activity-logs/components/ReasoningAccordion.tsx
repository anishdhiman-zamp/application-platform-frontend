...
const ReasoningAccordion = ({ thoughtSteps }: ReasoningAccordionProps) => {
  return (
    <Accordion type='single' collapsible className='w-full max-w-[485px] min-w-[180px] mt-2'>
      <AccordionItem value='item-1' className='border border-GRAY_100 rounded-t-md rounded-br-md w-full'>
        ...
        <AccordionContent className='max-h-40 overflow-y-scroll border-t border-GRAY_100 p-4 f-12-450 flex flex-col gap-y-2 w-full'>
