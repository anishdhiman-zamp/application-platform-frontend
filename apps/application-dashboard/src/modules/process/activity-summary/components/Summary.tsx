    ...
    <div className='flex flex-col items-start justify-start w-full'>
      ...
      <div className='flex flex-col items-start justify-start w-full'>
        {Object.entries(data?.values).map(([key, value]) => (
          <div key={key} className='grid grid-cols-[180px_1fr] items-center w-full gap-x-3'>
            <p className='f-12-450 text-GRAY_900 truncate max-w-[180px] capitalize' title={key}>
              {key}
            </p>
