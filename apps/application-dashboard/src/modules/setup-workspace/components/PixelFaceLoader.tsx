...
import { ZAMP_COLORS } from '@/modules/setup-workspace/utils/avatarGenerator';

// 14-col grid matching BASE_HEAD from avatarGenerator.
// .=empty, S=skin, H=hair, E=eye, M=mouth, B=blush
...
// Match seed avatar proportions: pill=88%, rx=28%
const CELL_SIZE = 6;
