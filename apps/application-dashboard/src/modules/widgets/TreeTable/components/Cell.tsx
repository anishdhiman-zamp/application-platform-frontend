...
const TreeCell: FC<TreeCellProps> = ({
  ...
  return (
    <div
      className={cn(
        'text-GRAY_950 border-b-0.5 border-b-GRAY_400 border-r-0.5 border-r-GRAY_400 f-13-450 hover:bg-GRAY_100 flex h-full w-full cursor-pointer select-none items-center justify-end gap-3 px-3 py-2',
        {
