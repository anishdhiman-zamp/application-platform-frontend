    ...
    <div className='border-GRAY_400 flex flex-col gap-y-2.5 border-b p-3'>
      ...
      <div className='flex items-center gap-x-2'>
        ...
        <div className='flex items-center'>
          ...
          >
            <ArrowUp className={cn('text-GRAY_1000 size-3.5', sortDirection === 'asc' && 'text-GRAY_300')} />
            <ArrowDown className={cn('text-GRAY_1000 size-3.5', sortDirection === 'desc' && 'text-GRAY_300')} />
          </Button>
