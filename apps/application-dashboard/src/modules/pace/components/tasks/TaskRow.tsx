  ...
  return (
    ...
    >
        ...
        {task.total_subtasks > 0 && (
          ...
          >
            <SubtaskPopover
              ...
              completedCount={task.completed_subtasks}
              totalCount={task.total_subtasks}
            />
          </div>
        )}
      ...
      <div className='flex shrink-0 items-center gap-3.5 px-4 py-2.5'>
        <div className='border-GRAY_400 flex cursor-pointer items-center gap-1.5 rounded-full border px-2 py-1.5'>
