...
const TableSchemaAlignmentStatus: FC<TableSchemaAlignmentStatusPropsType> = ({
  ...
  return (
    <div className='animate-slide-in-out absolute flex justify-center items-start gap-5 right-0 top-8 border-[0.5px] border-GRAY_500 rounded-2.5 py-3 px-5 w-[300px] bg-white z-1000 shadow-table-filter-menu'>
