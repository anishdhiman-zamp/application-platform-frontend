...
export const TOGGLE_SWITCH_STYLES = {
  ...
  [TOGGLE_SWITCH_TYPES.UNSELECTED]: {
    [TOGGLE_SWITCH_STATE_TYPES.ENABLED]: 'bg-GRAY_400 box-content border-GRAY_400',
...
export const TOGGLE_SWITCH_SLIDER = {
  [TOGGLE_SWITCH_TYPES.SELECTED]: {
    ...
    [TOGGLE_SWITCH_STATE_TYPES.DISABLED]: 'bg-GRAY_400 right-[3px]',
  },
  [TOGGLE_SWITCH_TYPES.UNSELECTED]: {
    [TOGGLE_SWITCH_STATE_TYPES.ENABLED]: 'left-[3px] bg-white',
    [TOGGLE_SWITCH_STATE_TYPES.DISABLED]: 'bg-GRAY_400 left-[3px]',
  },
};
