...
export const RADIO_STATE_STYLES = {
  [RADIO_TYPES.SELECTED]: {
    ...
    [RADIO_STATE_TYPES.HOVER]: 'hover:bg-white hover:ring-14 hover:ring-LIGHT_PRIMARY_1',
  ...
  [RADIO_TYPES.UNSELECTED]: {
    ...
    [RADIO_STATE_TYPES.HOVER]: 'hover:bg-white hover:border-TEXT_PRIMARY hover:ring-14 hover:ring-LIGHT_PRIMARY_1',
    [RADIO_STATE_TYPES.PRESSED]: 'active:bg-TEXT_PRIMARY hover:ring-LIGHT_PRIMARY_2',
