...
export const NEEDS_ATTENTION_EMPTY_STATE = '/images/empty-state/needs-attention.webp';
export const DONE_EMPTY_STATE = '/images/empty-state/done.webp';
export const IN_PROGRESS_EMPTY_STATE = '/images/empty-state/in-progress.webp';
