...
import { CreatePolicyPayloadType } from '@/unused/apis/paymentApi.types';
import { useCreatePolicyMutation, useGetPaymentConfigQuery, useUpdatePolicyMutation } from '@/unused/apis/payments';
import { defaultConditions, getAttributes, transformFormDataToApiPayload } from '@/unused/modules/policies/commons';
import { DEFAULT_APPROVAL_STEP } from '@/unused/modules/policies/constants';
import ApprovalFlow from '@/unused/modules/policies/create/ApprovalFlow';
import AttributeInputDropdown from '@/unused/modules/policies/create/AttributeInputDropdown';
import AttributeMenuDropdown from '@/unused/modules/policies/create/AttributeMenuDropdown';
...
import {
  ...
  PolicyDialogType,
  PolicyFormData,
} from '@/unused/modules/policies/types';
