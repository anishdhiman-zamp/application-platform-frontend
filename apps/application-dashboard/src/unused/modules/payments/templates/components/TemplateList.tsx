...
import { useGetTemplateListQuery } from '@/unused/apis/payments';
import TemplateFilter from '@/unused/modules/payments/move-money/components/TemplateFilter';
import { MOVE_MONEY_TEMPLATE_FILTER_ITEMS } from '@/unused/modules/payments/payments.constant';
import { type MOVE_MONEY_TYPE, TEMPLATE_STATUS_TYPES } from '@/unused/modules/payments/payments.types';
import RecipientCardSkeleton from '@/unused/modules/payments/recipients/components/RecipientCardSkeleton';
import CreateTemplatePopover from '@/unused/modules/payments/templates/components/CreateTemplatePopover';
import TemplateCard from '@/unused/modules/payments/templates/components/TemplateCard';
import { TEMPLATE_LIST_TABS } from '@/unused/modules/payments/templates/templates.constant';
