...
const inputVariants = cva(
  'p-3 flex w-full rounded-md border border-gray-400 placeholder:text-gray-700 focus:border-gray-600 focus:ring-2 focus:ring-gray-400 bg-BG_WHITE autofill-override file:border-0 file:bg-transparent file:text-sm file:font-medium outline-hidden disabled:cursor-not-allowed disabled:opacity-50',
  {
    variants: {
      size: {
