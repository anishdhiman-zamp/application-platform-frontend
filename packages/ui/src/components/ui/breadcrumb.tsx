...
const Breadcrumb = forwardRef<HTMLElement, ComponentPropsWithoutRef<'nav'> & { separator?: ReactNode }>(
...
const BreadcrumbLink = forwardRef<HTMLAnchorElement, ComponentPropsWithoutRef<'a'> & { asChild?: boolean }>(
...
const BreadcrumbEllipsis = ({ className, children, ...props }: ComponentProps<'span'>) => (
  <span
    role='presentation'
    aria-hidden='true'
