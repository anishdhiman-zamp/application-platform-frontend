  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        'table-filter-menu': '1px 2px 10px 0px var(--GRAY_70)',
        ...
        'chatbot-shadow': '0px 2px 9.5px 1px var(--GRAY_70)',
        'keyboard-keys-shadow': '-1px -1px 0.25px 0px var(--GRAY_70) inset',
        'tab-shadow': '0 4px 20px 0 var(--GRAY_70)',
        'chat-section': '10px 0 50px 0 var(--GRAY_70)',
      },
      fontSize: {
        '8': [
          '0.5rem',
