...
export const BASE_API_URL = process.env.NEXT_PUBLIC_BASE_API_URL || 'https://api-dev.zamp.ai';
...
export const MEMBERSHIP_PENDING_PATH = '/membership-pending';
export const SETUP_WORKSPACE_PATH = '/setup-workspace';
