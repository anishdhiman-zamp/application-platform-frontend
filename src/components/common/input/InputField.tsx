...
const sizeClassName = {
  ...
  [SIZE_TYPES.MEDIUM]: {
    ...
    inputClassWithoutLeadingIcon: 'h-[40px] py-4 pl-2.5 pr-[54px]',
    inputClassWithoutTrailingIcon: 'h-[40px] py-4 pl-[60px] pr-2.5',
  ...
  [SIZE_TYPES.SMALL]: {
    ...
    inputClassWithoutLeadingIcon: 'h-[32px] py-3 pl-2 pr-[50px]',
    inputClassWithoutTrailingIcon: 'h-[32px] py-3 pl-14 pr-2',
  ...
  [SIZE_TYPES.XSMALL]: {
    ...
    inputClassWithoutLeadingIcon: 'h-7 py-1.5 pl-2 pr-[30px]',
