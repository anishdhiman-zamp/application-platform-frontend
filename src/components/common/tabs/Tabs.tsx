...
export const Tabs: FC<TabsProps> = ({
  ...
  tabItemSelectedClassName = 'f-13-400 text-GRAY_700',
  tabItemDefaultClassName = 'f-13-300 text-GRAY_600',
  tabItemGapClassName = 'mr-8',
  indicatorClassName = 'absolute bottom-[-1.5px] border-[1.5px] transition-all',
  selectedTabIndicatorClassName = 'border-GRAY_700 !border-b-2 w-full',
  scrollWrapperStyle = '',
  wrapperStyle = '',
  tabItemWrapperStyle = '',
  tabItemStyle = '',
