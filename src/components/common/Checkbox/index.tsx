...
export const CheckBox: React.FC<CheckBoxProps> = ({
    ...
    return (
        <div
            className={`h-3.5 w-3.5 flex items-center relative ${className}`}
            data-testid={`checkbox-wrapper-${id}`}
        >
            <input
                type='checkbox'
                value=''
            ...
            <span
                ...
                data-checkboxid='check-box'
                className={`absolute top-0 left-0 h-3.5 w-3.5 rounded ${isCustomCheckMark ? customCheckMarkClassName : checkmarkStyles
                    }  ${displayContainerClassName} ${checkBoxStylesByState}`}
